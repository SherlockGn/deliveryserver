...
import com.wsn.courier.scan.camera.CameraManager;
import com.wsn.courier.scan.decode.DecodeThread;
import com.wsn.courier.scan.utils.BeepManager;
import com.wsn.courier.scan.utils.CaptureActivityHandler;
import com.wsn.courier.scan.utils.InactivityTimer;
...
//        userScan?userid=xxx&userusername=xxx&indentid=xxx 
        ...
        String URL = url+"userScan?userid="+Session.getCurrUserVO().getUserId()
