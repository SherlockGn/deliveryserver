...
import com.wsn.courier.adapter.FragmentAdapter;
import com.wsn.courier.fragment.friendFragment;
import com.wsn.courier.fragment.indentFragment;
import com.wsn.courier.fragment.mineFragment;
...
public class MainActivity extends FragmentActivity implements OnClickListener{
	...
	//Tab显示内容
	private TextView tv_indent,tv_friend,tv_mine;
	//Tab引导线
	private ImageView mTabLineIv;
	//Fragment
	private indentFragment mIndentFg;
	private friendFragment mFriendFg;
//	private courierFragment mCourierFg;
...
//		tv_courier = (TextView) findViewById(R.id.tv_courier);
...
//		tv_courier.setTextColor(getResources().getColor(R.color.color_dark_grey));
		...
		case 1:
			...
			break;
		case 2:
//			tv_courier.setTextColor(getResources().getColor(R.color.text_color_category_brown));
//			break;
//		case 3:
