...
//									bundle.putString("desc", desc);
	...
	private boolean judge() {
		...
		if("".equals(account)){
			Toast.makeText(RegisterActivity.this, "账号不可以为空", Toast.LENGTH_LONG).show();
			return false;
		}
		passWord = et_password.getText().toString().trim();
		if("".equals(passWord)){
			Toast.makeText(RegisterActivity.this, "密码不可以为空", Toast.LENGTH_LONG).show();
			return false;
		}
		secondPassWord = et_secondPassword.getText().toString().trim();
		if("".equals(secondPassWord)){
			Toast.makeText(RegisterActivity.this, "确认密码不可以为空", Toast.LENGTH_LONG).show();
			return false;
		...
		if("".equals(name)){
			Toast.makeText(RegisterActivity.this, "姓名不可以为空", Toast.LENGTH_LONG).show();
			return false;
		}
		gender = et_gender.getText().toString().trim();
		if("".equals(gender)){
			Toast.makeText(RegisterActivity.this, "性别不可以为空", Toast.LENGTH_LONG).show();
			return false;
		...
		if("".equals(phone)){
			Toast.makeText(RegisterActivity.this, "电话不可以为空", Toast.LENGTH_LONG).show();
			return false;
		}
		...
		if("".equals(address)){
			Toast.makeText(RegisterActivity.this, "地址不可以为空", Toast.LENGTH_LONG).show();
			return false;
		}	
		return true;
	}
